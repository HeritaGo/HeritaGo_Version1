  ...
  const destinations = [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1544735716-392fe2489ffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      icon: Mountain,
    },
    {
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1551969014-7d2c4cddf0b6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600",
      icon: Camera,
    },
  ];
  ...
  const roleFeatures = [
    {
      ...
      description:
        "Plan your perfect Sri Lankan adventure with AI assistance and local insights",
      features: [
        "AI Travel Planner",
        "Interactive Maps",
        "Quest Mode Gaming",
    ...
    },
    {
      ...
      description:
        "Connect with travelers and showcase the beauty of Sri Lanka",
      features: [
        "Manage Tours",
        "Earnings Dashboard",
        "Client Reviews",
    ...
    },
    {
      ...
      description:
        "Comprehensive oversight and analytics for the entire platform",
      features: [
        "User Management",
        "Analytics Dashboard",
        "Content Moderation",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Whether you're a traveler, guide, vendor, or admin - HeritaGo
                adapts to your unique needs with intelligent dashboards and
                powerful tools.
              </p>
            </motion.div>
              ...
              {roleFeatures.map((feature, index) => (
                ...
                >
                  <Card className="group relative overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                    <div
                      className={`h-32 bg-gradient-to-br ${feature.color} relative overflow-hidden`}
                    >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                From ancient kingdoms to pristine beaches, from misty mountains
                to vibrant cities - explore the diverse beauty of the Pearl of
                the Indian Ocean.
              </p>
            </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Explore destinations with real-time weather, emergency alerts,
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Experience Sri Lanka like never before with our cutting-edge
                features and local expertise.
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description:
                    "Smart travel recommendations based on your preferences, budget, and travel style.",
                },
                {
                  icon: Users,
                  title: "Expert Local Guides",
                  description:
                    "Connect with certified local guides who know the hidden gems and cultural secrets.",
                },
                {
                  icon: Shield,
                  title: "Safety First",
                  description:
                    "Real-time alerts, emergency support, and comprehensive safety information.",
                },
                {
                  icon: Trophy,
                  title: "Quest Mode",
                  description:
                    "Gamified exploration with challenges, rewards, and achievement badges.",
                },
                {
                  icon: Calendar,
                  title: "Smart Booking",
                  description:
                    "Seamless hotel and gear rental bookings with instant confirmation.",
                },
                {
                  icon: Star,
                  title: "Community Driven",
                  description:
                    "Reviews, tips, and experiences shared by fellow travelers and locals.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={feature.title}
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Join thousands of travelers who have discovered the magic of Sri
                Lanka with HeritaGo's intelligent travel companion.
              </p>
